...
my %options =  (output_dir => './',run_name => 'Strep',make_3p_table_output => 0,'3p_min_rep' => 1,'3p_min_avg_cov' => 2,
				TSS_min_cov => 2, '5UTR_max_len' => 500, min_TAPnoTAP_ratio => 1,use_intergenic => 1,max_3utr_length=>150,
...
#	print "@$genes_array_ref->[$gene_obj]\n";
}
